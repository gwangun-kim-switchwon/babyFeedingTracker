...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `feeding_records` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `timestamp` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '55fd2e3f847c5a74fd64d64551df1041')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsFeedingRecords = new HashMap<String, TableInfo.Column>(2);
        _columnsFeedingRecords.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFeedingRecords.put("timestamp", new TableInfo.Column("timestamp", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoFeedingRecords.equals(_existingFeedingRecords)) {
          return new RoomOpenHelper.ValidationResult(false, "feeding_records(com.baby.feedingtracker.data.FeedingRecord).\n"
                  + " Expected:\n" + _infoFeedingRecords + "\n"
                  + " Found:\n" + _existingFeedingRecords);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "55fd2e3f847c5a74fd64d64551df1041", "74232f64f1e455399ad647974c5b903f");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "feeding_records");
  }
